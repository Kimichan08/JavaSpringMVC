...
<div class="pcoded-main-container px-3 py-3">
	<h2 class="text-center text-success font-weight-bold ">UPDATE
		PRODUCT</h2>
	<f:form method="post" action="${pageContext.request.contextPath}/admin/cap-nhat-san-pham" modelAttribute = "product" enctype="multipart/form-data">
		<div class="form-group">
			<label for="exampleInputEmail1">Product ID</label>
			<f:input path="proId" cssClass="form-control" readonly="true"/> 
		</div>
		...
		<div class="form-group">
			<div class="form-group">
				...
				<f:select path="status"
					cssClass="form-control rounded-0 border bg-white mb-3 px-3">
					<f:option value="1">Out of stock</f:option>
					<f:option value="0">Stocking</f:option>
				</f:select>
			</div>
		</div>
	...
	<a href="${baseURL }/admin/danh-sach-san-pham" class="btn btn-info mt-3">Back List Product</a>
